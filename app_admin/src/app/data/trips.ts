export const trips = [
  ...
  },
  {
    ...
    "perPerson" : "1199.00",
    "image" : "reef2.jpg",
    "description" : "<p>Dawson’s Reef Integer magna leo, posuere et dignissim ac, tristique quis nisl. Morbi aliquet viverra ante, in gravida sem. Etiam nec ligula vel sapien lacinia bibendum.</p><p>Sed vitae feugiat lorem. In vel erat sed ligula dictum cursus.</p>"
  },
  {
    "code" : "CLAR210621",
    "name" : "Claire's Reef",
    ...
    "perPerson" : "1999.00",
    "image" : "reef3.jpg",
    "description" : "<p>Claire’s Reef Donec sed felis risus. Nulla facilisi. Integer purus justo, pretium ut turpis nec, cursus in tortor. Etiam varius suscipit lacus nec rutrum. Suspendisse potenti. Vestibulum ante ipsum primis in faucibus.</p>"
  }
];
